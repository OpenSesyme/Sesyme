...
public class InterestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView fictionImg = interestsView.findViewById(R.id.fiction_img_interests);
        ...
        ImageView thrillerImg = interestsView.findViewById(R.id.thriller_img_interests);
        ...
        fictionImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                methods.LocateStringInterests(interests, sLaw, fictionThumb);
                if (interests.size() > 2) {
                    save.setVisibility(View.VISIBLE);
                } else {
                    save.setVisibility(View.GONE);
        ...
        thrillerImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                methods.LocateStringInterests(interests, sComputer, thrillerThumb);
                if (interests.size() > 2) {
                    save.setVisibility(View.VISIBLE);
                } else {
                    save.setVisibility(View.GONE);
