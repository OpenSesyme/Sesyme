...
public class SearchPostAdapter extends ArrayAdapter<WritePostClass> implements Filterable {
    ...
    public SearchPostAdapter(@NonNull Context context, List<WritePostClass> list) {
    ...
    public View getView(int position, @Nullable View itemView, @NonNull ViewGroup parent) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (thisPost != null) {
                    intent.putExtra(SefnetContract.REFERENCE, thisPost.getId());
                }
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence == null || charSequence.length() == 0){
                ...
                for (WritePostClass post: allQuestions){
                    String text = post.getTitle() + post.getDescription();
                    if (text.toLowerCase().contains(searchString)){
