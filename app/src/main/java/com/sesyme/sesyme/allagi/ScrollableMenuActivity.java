...
public class ScrollableMenuActivity extends AppCompatActivity {
    ...
    private static final int STROKE_HEIGHT = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linePageIndicator = findViewById(R.id.titles);
    ...
    private void setUpLinePageIndicator() {
        ...
        linePageIndicator.setStrokeWidth(STROKE_HEIGHT);
        linePageIndicator.setLineWidth(AllagiUtils.getLineWidth(getApplicationContext()));
        linePageIndicator.setGapWidth(STROKE_GAP);
        linePageIndicator.setSelectedColor(getResources().getColor(R.color.iconsColor));
    ...
    private void initializeTabs() {
        for (int i = 0; i < tabLayout.getTabCount(); i++) {
            ...
            TextView iv = view.findViewById(R.id.img_reply);
