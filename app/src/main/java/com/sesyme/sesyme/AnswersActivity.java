...
public class AnswersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            if (type.equals(SefnetContract.QUESTIONS)) {
                                ...
                                RepliesRef = db.collection(SefnetContract.QUESTIONS)
                                        .document(id).collection(SefnetContract.REFERENCE);
                            } else {
        ...
        if (intent.hasExtra(SefnetContract.REFERENCE)) {
            id = intent.getStringExtra(SefnetContract.REFERENCE);
        }
        ...
        {
            id = getIntent().getStringExtra(SefnetContract.REFERENCE);
        }
                                    ...
                                    if (author != null) {
                                        ...
                                        user.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                            ...
                                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                ...
                                                Glide.with(AnswersActivity.this.getApplicationContext()).load(userImageUrl)
        ...
        share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                methods.generateDeepLinkQuestion(questionsRef.document(id).getPath(), titleString, userNameString, author);
            }
        });
        ...
        userName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(AnswersActivity.this, OthersProfile.class);
                intent1.putExtra(SefnetContract.PROFILE_REF, author);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                writeReviewIntent.putExtra(SefnetContract.REFERENCE, id);
    ...
    private void setUpRecyclerView() {
        Query query = RepliesRef.orderBy("dateTime", Query.Direction.ASCENDING);
